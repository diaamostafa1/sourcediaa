...
print('\n\27[1;34m Welcome to the all-new and powerful Source diaa ')
file = io.open("diaa", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/diaa
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevdiaaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
diaa_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
diaa_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
diaa_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
diaa_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function Sourcediaa(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/BO6OK)}\n ❃∫ ["..BOYKA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/BO6OK)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
